...
struct TranscriptProjectionMemoTests {
  ...
  /// execution feed, but the memo must not corrupt) resets and re-folds, and can grow
  ...
  /// whose tail event was mutated in place (which the append-only execution feed never
